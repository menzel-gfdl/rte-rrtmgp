...
type, private :: Argument_t
  character(len=32) :: short_name !< Short name (must start with a - if it is optional).
  character(len=32) :: long_name !< Long name (must start with a --).
  character(len=512) :: description !< Description that will appear in the help message.
